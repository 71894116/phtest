...
senvenProvide("moorCall.stateElement.link.dialoutTransferLink");
senvenProvide("moorCall.stateElement.link.normalTransferLink");
...
sevenDeclare("moorCall.stateElement.link.dialoutTransferLink", null, {
  constructor: function(base) {
    this.m7Base = base;
  },
  ...
  m7CallState: "stDialTransferTalking",
...
sevenDeclare("moorCall.stateElement.link.normalTransferLink", null, {
  constructor: function(base) {
    this.m7Base = base;
  },
  m7CallState: "stTransferTalking",
  m7Base: null,
    ...
    if(evtJson.Event == "ChannelStatus" && evtJson.Exten == this.m7Base.m7Phone.sipNo) {
      if(evtJson.ChannelStatus == "Link") {
        if(evtJson.LinkedChannel.ChannelType == "dialout") {
          ...
          // this.m7Base.m7CurrentCallState = this.m7Base.m7getPhoneDialoutLink();
          this.m7Base.m7CurrentCallState = this.m7Base.m7getPhoneDialoutTransferLink();
          this.m7changeToolBarState(this.m7Base.m7CurrentCallState);
        }
  ...
  m7ChooiceCallState: function(evtJson) {
    if(evtJson.Event == "ChannelStatus" && evtJson.Exten == this.m7Base.m7Phone.sipNo) {
      if (evtJson.ChannelStatus == "Hangup") {
        ...
        // this.m7Base.m7CurrentCallState = this.m7Base.m7getPhoneNormalLink();
        this.m7Base.m7CurrentCallState = this.m7Base.m7getPhoneNormaTransferlLink();
        this.m7changeToolBarState(this.m7Base.m7CurrentCallState);
        if(this.m7Base.m7Phone.m7IsRing) {
          this.m7Base.m7Phone.m7StopSound();
          this.m7Base.m7Phone.m7IsRing = false;
...
sevenDeclare("moorCall.stateElement.base", null , {
  ...
  m7getPhoneNormaTransferlLink: function() {
    if(this.m7Phone.m7NormalTransferLink == null) {
      this.m7Phone.m7NormalTransferLink = new moorCall.stateElement.link.normalTransferLink(this);
    }
    return this.m7Phone.m7NormalTransferLink;
  },
  ...
  m7getPhoneDialoutTransferLink: function() {
    if(this.m7Phone.m7DialoutTransferLink == null) {
      this.m7Phone.m7DialoutTransferLink = new moorCall.stateElement.link.dialoutTransferLink(this);
    }
    return this.m7Phone.m7DialoutTransferLink;
  },
    ...
    if (evtJson.Event == "ChannelStatus") {
      if(evtJson.Exten == this.m7Phone.sipNo) {
        if(evtJson.ChannelStatus == "Ring"){
          ...
          var errorData = {eventJson: "Ring", catchRecord: evtJson, errorTime: currentTime}
          ...
          this.m7Phone.m7CurentChannel = evtJson.Channel;
          var currentTime = moorCall.recordError.getCurrentTime();
          var errorData = {eventJson: "Ringing", catchRecord: evtJson, errorTime: currentTime}
          moorCall.recordError.dataHandle(errorData)
        } else if (evtJson.ChannelStatus == "Link") {
          m7IsCalling = true;
          this.m7Phone.m7CurentChannel = evtJson.Channel;
          ...
          var currentTime = moorCall.recordError.getCurrentTime();
          var errorData = {eventJson: "Link", catchRecord: evtJson, errorTime: currentTime}
          moorCall.recordError.dataHandle(errorData)
          ...
          if(this.m7Phone.m7CurentChannel == evtJson.Channel) {
            if (evtJson.ChannelType == "normal" || evtJson.ChannelType == "dialout"
              ...
              var currentTime = moorCall.recordError.getCurrentTime();
              var errorData = {eventJson: "eventHangup", errorTime: currentTime}
              moorCall.recordError.dataHandle(errorData)
          ...
          var currentTime = moorCall.recordError.getCurrentTime();
          var errorData = {eventJson: "Hangup", catchRecord: evtJson, errorTime: currentTime}
          moorCall.recordError.dataHandle(errorData)
        }
...
sevenDeclare("moorCall.SoftphoneBar", null, {
  constructor: function(phone,srcNodeName) {
    ...
    this.m7CallStateDescription["stTransferTalking"] = "呼入转接通话";
    ...
    this.m7CallStateDescription["stDialTransferTalking"] = "外呼转接通话";
  ...
  m7PeerCalculagraph: null,
    ...
    Local_stDialTransferTalking: ["DialDisable", "smallDialDisable", "HangupEnable", "HoldEnable", "ThreeWayCallDisable", "TransferEnable","ConsultEnable", "StopConsultDisable", "transferIVREnable","transferSatisfactionEnable"],
    ...
    Local_stTransferTalking: ["DialDisable", "smallDialDisable", "HangupEnable", "HoldEnable", "ThreeWayCallDisable", "TransferEnable", "ConsultEnable", "StopConsultDisable", "transferIVREnable","transferSatisfactionEnable"],
    ...
    gateway_stTransferTalking: ["DialDisable", "smallDialDisable", "HangupEnable", "HoldEnable", "ThreeWayCallDisable", "TransferEnable", "ConsultEnable", "StopConsultDisable","transferIVREnable","transferSatisfactionEnable"],
    ...
    gateway_stDialTransferTalking: ["DialDisable", "smallDialDisable", "HangupEnable", "HoldEnable", "ThreeWayCallDisable", "TransferEnable","ConsultEnable", "StopConsultDisable","transferIVREnable","transferSatisfactionEnable"],
    ...
    sip_stDialTransferTalking: ["DialDisable", "smallDialDisable", "HangupEnable", "HoldEnable", "ThreeWayCallDisable", "TransferEnable","ConsultEnable", "StopConsultDisable","transferIVREnable","transferSatisfactionEnable"],
    ...
    sip_stTransferTalking: ["DialDisable", "smallDialDisable", "HangupEnable", "HoldEnable", "ThreeWayCallDisable", "TransferEnable", "ConsultEnable", "StopConsultDisable","transferIVREnable","transferSatisfactionEnable"],
    ...
    if(this.m7SrcNodePeerStateDom != null) {
      ...
      if (nodeInnerText == "失效" || nodeInnerText == "后处理") {
        ...
        var errorData = {
          eventJson: "GetState",
          type: nodeInnerText,
          catchRecord: currentEventObj,
          errorTime: currentTime,
          otherData: {peerState: peerState}
        };
        moorCall.recordError.dataHandle(errorData);
      }
        if(peerState != "99") {
  ...
  m7AutoBusyTime: function (AutoBusyTime) {
    if (this.m7SrcNodePeerStateDom != null) {
      this.m7SrcNodePeerStateDom.innerHTML =
        this.m7Phone.m7PeerState._get("99").value;
      var nodeInnerText = this.m7SrcNodePeerStateDom.innerText;
      if (nodeInnerText == "失效" || nodeInnerText == "后处理") {
        var currentTime = moorCall.recordError.getCurrentTime();
        var errorData = {
          ...
          catchRecord: currentEventObj,
          errorTime: currentTime,
          otherData: {AutoBusyTime: AutoBusyTime}
        };
        moorCall.recordError.dataHandle(errorData);
      }
    }
